...
const RevisionIndusDesign = ({ progresSubmission, formIndustDesign, formIndustDesignError, handleChangeComplateIndusDesign, handleSubmitComplateIndusDesign, handleClaimCheckboxChange }: FormRevisionProps) => {
