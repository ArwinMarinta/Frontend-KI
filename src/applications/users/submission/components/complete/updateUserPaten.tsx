      ...
      <div className="lg:w-[84%] w-full  border ">
        ...
        <div className=" px-4 lg:px-12  py-8 ">
          ...
          <div className="lg:p-16 p-4 rounded-md bg-white shadow-md border border-gray-50 ">
            ...
            {currentStep === 0 && <FormReview draftPatent={draftPatent} handleChange={handleDraftPatenChange} errorDraftPatent={errorDraftPatent} handleNextStep1={handleNextStep1} url={detailSubmission?.submission?.patent?.draftPatentApplicationFile} types={types} />}
            {currentStep === 1 && (
              <Form_2
