...
const RevisionPaten = ({ progresSubmission, formComplatePaten, formComplatePatenError, handleChangeComplatePaten, handleSubmitComplatePatent }: FormComplatePatentProps) => {
