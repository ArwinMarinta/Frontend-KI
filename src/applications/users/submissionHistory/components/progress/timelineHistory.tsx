        ...
        <div key={id} className="flex items-start space-x-2">
          ...
          <div className="flex w-[85%] ">
            ...
            <div className="relative flex flex-col items-center px-4">
              {/* Garis vertikal */}
              <div className="absolute top-0 bottom-0 w-[2px] bg-[#D9D9D9]" />
              {/* Lingkaran */}
              <div className="w-5 h-5 bg-[#D9D9D9] rounded-full border-2 border-[#D9D9D9] dark:border-gray-800 z-10 mt-4" />
            </div>
            {/* Column 3: Content */}
