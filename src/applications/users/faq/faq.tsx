    ...
    <>
      ...
      <main className="w-full flex justify-center">
        <div className="container w-full h-full">
          ...
          <section id="section-2" className="flex flex-row">
            <div className="flex flex-col w-[30%] justify-start border p-4 rounded-md gap-2">
              <button className="text-start px-6 py-2 bg-PRIMARY01 text-white rounded-md font-medium">
                <span>Umum</span>
              </button>
              <button className="text-start px-6 py-2 bg-PRIMARY01 text-white rounded-md font-medium">
                <span>Paten</span>
